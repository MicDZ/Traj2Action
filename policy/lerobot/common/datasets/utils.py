...
#         elif key.startswith("observation") or "state" in key.lower():
...
def dataset_to_policy_features(features: dict[str, dict]) -> dict[str, PolicyFeature]:
    ...
    for key, ft in features.items():
        ...
        elif key.startswith("observation") or key.lower() == "state":
            type = FeatureType.STATE
        elif key.startswith("observation") or key.lower() == "state_trajectory":
            type = FeatureType.STATE_TRAJ
        # elif key.startswith("action"):
        elif key.lower() == "actions":
            type = FeatureType.ACTION
        elif key.lower() == "trajectory":
            type = FeatureType.TRAJ
        else:
            continue
